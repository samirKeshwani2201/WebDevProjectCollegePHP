        ...
        <form action="backend/registerProcess.php" method="post">
            <div class="user-details">
                <div class="input-box">
                    ...
                    <input type="text" id="name" name="f_name" placeholder="Enter Your First Name">
                </div>
                <div class="input-box">
                    <span class="details">Last Name</span>
                    <input type="text" id="userName" name="l_name" placeholder="Enter Your Last Name">
                </div>
                ...
                <div class="input-box">
                    ...
                    <input type="text" id="mobile" name="mobile" placeholder="Enterww Your Phone Number">
                </div>
                <div class="input-box">
